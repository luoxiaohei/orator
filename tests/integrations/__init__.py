...
class IntegrationTestCase(object):
    ...
    def test_timestamp_with_timezone(self):
        ...
        self.assertEqual(
            user.created_at.to_date_string(), fresh_user.created_at.to_date_string()
        )
    ...
    def test_touches(self):
        ...
        self.assertEqual(
            comment4.updated_at.to_date_string(),
            OratorTestComment.find(comment4.id).updated_at.to_date_string(),
        )
        self.assertTrue(
            comment3_updated_at < OratorTestComment.find(comment3.id).updated_at
        )
        self.assertEqual(
            comment1_updated_at.to_date_string(),
            OratorTestComment.find(comment1.id).updated_at.to_date_string(),
        )
        self.assertEqual(
            comment2_updated_at.to_date_string(),
            OratorTestComment.find(comment2.id).updated_at.to_date_string(),
        )
